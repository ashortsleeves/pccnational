<?php
/*
Plugin Name: Gravity Forms PayPal Commerce Platform Add-On
...
------------------------------------------------------------------------
Copyright 2019 Rocketgenius Inc.
...
// Defines the current version of the Gravity Forms PayPal Commerce Platform Add-On.
define( 'GF_PPCP_VERSION', '1.0.1' );

// Defines the minimum version of Gravity Forms required to run Gravity Forms PayPal Commerce Platform Add-On.
define( 'GF_PPCP_MIN_GF_VERSION', '2.4' );

// After Gravity Forms is loaded, load the Add-On.
add_action( 'gform_loaded', array( 'GF_PPCP_Bootstrap', 'load_addon' ), 5 );

/**
 * Loads the Gravity Forms PayPal Commerce Platform Add-On.
 *
...
class GF_PPCP_Bootstrap {
	...
	public static function load_addon() {
		...
		require_once plugin_dir_path( __FILE__ ) . '/class-gf-ppcp.php';
